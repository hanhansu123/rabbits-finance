...
public:
  ...
  static constexpr name MINED_TOKEN = name("rabbitstoken");
  static constexpr name ADMIN = name("rabbitsadmin");
  static constexpr symbol MINED_SYMBOL = symbol("RAB", 4);
  static constexpr symbol_code MINED_SYMBOL_CODE = symbol_code("RAB");
