...
public:
  ...
  {
    const symbol sym = symbol(SY(4, RAB));
...
try
{
  ...
  BOOST_REQUIRE_EQUAL(error("missing authority of rabbitsadmin"),
                      push_xpool_action(N(eosio), N(create), mvo()("contract", N(eosio.token))("sym", "4,EOS")("reward", asset::from_string("13000.0000 RAB"))("epoch_time", epoch)("duration", duration)("min_staked", asset::from_string("1.0000 EOS"))("type", 0)));
  ...
  BOOST_REQUIRE_EQUAL(wasm_assert_msg("Min staked symbol error"),
                      xpool_create(N(eosio.token), symbol(SY(4, EOS)), asset::from_string("13000.0000 RAB"), epoch, duration, asset::from_string("1.0000 EOSX"), 0));
  BOOST_REQUIRE_EQUAL(wasm_assert_msg("Invalid epoch"),
                      xpool_create(N(eosio.token), symbol(SY(4, EOS)), asset::from_string("13000.0000 RAB"), 0, duration, asset::from_string("1.0000 EOS"), 0));
  BOOST_REQUIRE_EQUAL(wasm_assert_msg("Invalid duration"),
                      xpool_create(N(eosio.token), symbol(SY(4, EOS)), asset::from_string("13000.0000 RAB"), epoch, 0, asset::from_string("1.0000 EOS"), 0));
  BOOST_REQUIRE_EQUAL(wasm_assert_msg("Reach the max circulation"),
                      xpool_create(N(eosio.token), symbol(SY(4, EOS)), asset::from_string("21000.0001 RAB"), epoch, duration, asset::from_string("1.0000 EOS"), 0));
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(eosio.token), symbol(SY(4, EOS)), asset::from_string("13000.0000 RAB"), epoch, duration, asset::from_string("1.0000 EOS"), 0));
  ...
  BOOST_REQUIRE_EQUAL(pool["total_reward"], "13000.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["released_reward"], "0.0000 RAB");
  ...
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(tethertether), symbol(SY(4, USDT)), asset::from_string("1930.0000 RAB"), epoch, duration, asset::from_string("1.0000 USDT"), 0));
  ...
  BOOST_REQUIRE_EQUAL(pool["total_reward"], "1930.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["released_reward"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["epoch_time"], epoch);
  BOOST_REQUIRE_EQUAL(pool["duration"], duration);
  ...
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(tokenaceosdt), symbol(SY(4, EOSDT)), asset::from_string("1030.0000 RAB"), epoch, duration, asset::from_string("1.0000 EOSDT"), 0));
  ...
  BOOST_REQUIRE_EQUAL(pool["total_reward"], "1030.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["released_reward"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["epoch_time"], epoch);
  BOOST_REQUIRE_EQUAL(pool["duration"], duration);
  ...
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(tokenaceusde), symbol(SY(4, USDE)), asset::from_string("1030.0000 RAB"), epoch, duration, asset::from_string("1.0000 USDE"), 0));
  ...
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(eosdmdtokens), symbol(SY(10, DMD)), asset::from_string("70.0000 RAB"), epoch, duration, asset::from_string("0.0200000000 DMD"), 0));
  ...
  BOOST_REQUIRE_EQUAL(pool["total_reward"], "70.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["released_reward"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["epoch_time"], epoch);
  BOOST_REQUIRE_EQUAL(pool["duration"], duration);
  ...
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(eosio.token), symbol(SY(4, EOS)), asset::from_string("2700.0000 RAB"), epoch, duration, asset::from_string("1.0000 EOS"), 1));
  ...
  BOOST_REQUIRE_EQUAL(pool["sym"], "4,EOS");
  BOOST_REQUIRE_EQUAL(pool["total_staked"], "0.0000 EOS");
  BOOST_REQUIRE_EQUAL(pool["total_reward"], "2700.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["released_reward"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["epoch_time"], epoch);
  BOOST_REQUIRE_EQUAL(pool["duration"], duration);
  BOOST_REQUIRE_EQUAL(pool["min_staked"], "1.0000 EOS");
...
try
{
  ...
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(tokenaceusde), symbol(SY(4, USDE)), asset::from_string("1030.0000 RAB"), epoch, duration, asset::from_string("1.0000 USDE"), 0));
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(eosdmdtokens), symbol(SY(10, DMD)), asset::from_string("70.0000 RAB"), 1597231491, duration, asset::from_string("0.0200000000 DMD"), 0));
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(eosio.token), symbol(SY(4, EOS)), asset::from_string("2700.0000 RAB"), epoch, duration, asset::from_string("1.0000 EOS"), 1));
  ...
  BOOST_REQUIRE_EQUAL(miner["claimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(miner["unclaimed"], "0.0000 RAB");
...
try
{
  ...
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(tokenaceosdt), symbol(SY(4, EOSDT)), asset::from_string("1030.0000 RAB"), epoch, duration, asset::from_string("1.0000 EOSDT"), 0));
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(tokenaceusde), symbol(SY(4, USDE)), asset::from_string("1030.0000 RAB"), 1630928988, duration, asset::from_string("1.0000 USDE"), 0));
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(eosdmdtokens), symbol(SY(10, DMD)), asset::from_string("70.0000 RAB"), 1597231491, duration, asset::from_string("0.0200000000 DMD"), 0));
  BOOST_REQUIRE_EQUAL(success(),
                      xpool_create(N(eosio.token), symbol(SY(4, EOS)), asset::from_string("2700.0000 RAB"), epoch, duration, asset::from_string("1.0000 EOS"), 1));
  ...
  BOOST_REQUIRE_EQUAL(miner1["claimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(miner1["unclaimed"], "0.0000 RAB");
  ...
  BOOST_REQUIRE_EQUAL(miner2["claimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(miner2["unclaimed"], "0.0000 RAB");
  ...
  BOOST_REQUIRE_EQUAL(pool["total_reward"], "13000.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["released_reward"], "630.3584 RAB");
  BOOST_REQUIRE_EQUAL(pool["epoch_time"], epoch);
  BOOST_REQUIRE_EQUAL(pool["duration"], duration);
  BOOST_REQUIRE_EQUAL(pool["min_staked"], "1.0000 EOS");

  BOOST_REQUIRE_EQUAL(asset::from_string("630.3584 RAB"), get_token_balance(N(rabbitstoken), "rabbitspoolx", symbol(SY(4, RAB))));

  miner1 = get_xpool_miner(N(rabbitsuser1), 1);
  BOOST_REQUIRE_EQUAL(miner1["owner"], "rabbitsuser1");
  BOOST_REQUIRE_EQUAL(miner1["staked"], "18.0000 EOS");
  BOOST_REQUIRE_EQUAL(miner1["claimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(miner1["unclaimed"], "315.1792 RAB");

  miner2 = get_xpool_miner(N(rabbitsuser2), 1);
  BOOST_REQUIRE_EQUAL(miner2["owner"], "rabbitsuser2");
  BOOST_REQUIRE_EQUAL(miner2["staked"], "18.0000 EOS");
  BOOST_REQUIRE_EQUAL(miner2["claimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(miner2["unclaimed"], "315.1792 RAB");
  ...
  BOOST_REQUIRE_EQUAL(pool["total_staked"], "36.0000 EOS");
  BOOST_REQUIRE_EQUAL(pool["total_reward"], "13000.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["released_reward"], "632.4984 RAB");
  BOOST_REQUIRE_EQUAL(pool["epoch_time"], epoch);
  BOOST_REQUIRE_EQUAL(pool["duration"], duration);
  BOOST_REQUIRE_EQUAL(pool["min_staked"], "1.0000 EOS");

  BOOST_REQUIRE_EQUAL(asset::from_string("632.4984 RAB"), get_token_balance(N(rabbitstoken), "rabbitspoolx", symbol(SY(4, RAB))));
  miner1 = get_xpool_miner(N(rabbitsuser1), 1);
  BOOST_REQUIRE_EQUAL(miner1["owner"], "rabbitsuser1");
  BOOST_REQUIRE_EQUAL(miner1["staked"], "18.0000 EOS");
  BOOST_REQUIRE_EQUAL(miner1["claimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(miner1["unclaimed"], "316.2492 RAB");

  miner2 = get_xpool_miner(N(rabbitsuser2), 1);
  BOOST_REQUIRE_EQUAL(miner2["owner"], "rabbitsuser2");
  BOOST_REQUIRE_EQUAL(miner2["staked"], "18.0000 EOS");
  BOOST_REQUIRE_EQUAL(miner2["claimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(miner2["unclaimed"], "316.2492 RAB");
  ...
  BOOST_REQUIRE_EQUAL(pool["total_staked"], "36.0000 EOS");
  BOOST_REQUIRE_EQUAL(pool["total_reward"], "13000.0000 RAB");
  BOOST_REQUIRE_EQUAL(pool["released_reward"], "634.6384 RAB");
  BOOST_REQUIRE_EQUAL(pool["epoch_time"], epoch);
  BOOST_REQUIRE_EQUAL(pool["duration"], duration);
  BOOST_REQUIRE_EQUAL(pool["min_staked"], "1.0000 EOS");
  BOOST_REQUIRE_EQUAL(asset::from_string("634.6384 RAB"), get_token_balance(N(rabbitstoken), "rabbitspoolx", symbol(SY(4, RAB))));

  miner1 = get_xpool_miner(N(rabbitsuser1), 1);
  BOOST_REQUIRE_EQUAL(miner1["owner"], "rabbitsuser1");
  BOOST_REQUIRE_EQUAL(miner1["staked"], "18.0000 EOS");
  BOOST_REQUIRE_EQUAL(miner1["claimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(miner1["unclaimed"], "317.3192 RAB");

  miner2 = get_xpool_miner(N(rabbitsuser2), 1);
  BOOST_REQUIRE_EQUAL(miner2["owner"], "rabbitsuser2");
  BOOST_REQUIRE_EQUAL(miner2["staked"], "18.0000 EOS");
  BOOST_REQUIRE_EQUAL(miner2["claimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(miner2["unclaimed"], "317.3192 RAB");
  ...
  miner2 = get_xpool_miner(N(rabbitsuser2), 1);
  BOOST_REQUIRE_EQUAL(miner2["staked"], "18.0000 EOS");
  BOOST_REQUIRE_EQUAL(miner2["claimed"], "317.3192 RAB");
  BOOST_REQUIRE_EQUAL(miner2["unclaimed"], "0.0000 RAB");
  BOOST_REQUIRE_EQUAL(asset::from_string("317.3192 RAB"), get_token_balance(N(rabbitstoken), "rabbitsuser2", symbol(SY(4, RAB))));
  ...
  BOOST_REQUIRE_EQUAL(miner2["staked"], "18.0000 EOS");
  BOOST_REQUIRE_EQUAL(miner2["claimed"], "317.3192 RAB");
  BOOST_REQUIRE_EQUAL(miner2["unclaimed"], "0.7133 RAB");
}
FC_LOG_AND_RETHROW()
